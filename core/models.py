...
class Usuario(models.Model):
    ...
    rut=models.CharField(max_length=15, unique=True, blank=False, null=True)
    ...
    nro_direccion=models.IntegerField( blank=False, null=True)
    comuna=models.IntegerField(choices=comuna_list, default=1, blank=False, null=True)
